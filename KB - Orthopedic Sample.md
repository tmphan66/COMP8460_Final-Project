Knowledge Base: Orthopedic

This document contains aggregated, anonymous sections for the 'Orthopedic' specialty, extracted from sample notes.

Example: PREOPERATIVE DIAGNOSIS

, Bilateral knee degenerative arthritis.

Example: POSTOPERATIVE DIAGNOSIS

, Bilateral knee degenerative arthritis.

Example: PROCEDURE PERFORMED

, Bilateral knee arthroplasty.,Please note this procedure was done by Dr. X for the left total knee and Dr. Y for the right total knee.This operative note will discuss the right total knee arthroplasty.
